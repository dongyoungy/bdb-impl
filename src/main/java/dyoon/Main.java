...
public class Main {
  ...
  private static void setQueries() {
    ...
    String q19QCS =
        "i_brand ,i_brand_id ,i_manufact_id ,i_manufact, i_manager_id, d_moy, d_year, ca_zip, s_zip";
    Query q19 =
        new Query(
            "19",
    ...
    q34JoinCols.add(ImmutablePair.of("ss_item_sk", "i_item_sk"));
    ...
    String q61Tables = "store_sales ,store ,promotion ,date_dim ,customer ,customer_address ,item";
    ...
    String q61QCS =
        "ca_gmt_offset, i_category, p_channel_dmail, p_channel_email, p_channel_tv, s_gmt_offset, d_year, d_moy";
    Query q61 =
        new Query(
            "61",
